...
## Project Structure
    ...
    ├── final_stage_test_sb_35943  # Django project configurations
...
1. Clone this repo and `cd final_stage_test_sb_35943`
...
2. Clone this repo and `cd final_stage_test_sb_35943`
